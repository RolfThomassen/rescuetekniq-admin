...
namespace RescueTekniq.BOL
{
    ...
    //		RettetDen,
    //		RettetIP
    //	FROM	vw_Co2Db_Infosites / Co2Db_DynamicSite
    //---------------------------------------------------------------------------
    //	SELECT
    //	ID	int
    //	Aktiv	bit
    ...
    public class Infosites : BaseObject
    {
...
#region  --== New ==--
        ...
        public Infosites(int ID, bool Aktiv, bool IncludeInMenu, bool IsDeleted, bool IsDisabled, string PageName, string PageTitle, string Description, string Keywords, int Template_ID, int Category_ID, int LinkType_ID, string LinkUrl, int LinkPage_ID, string LinkTarget, DateTime OpenDate, DateTime ExpireDate) : this()
        {
            var with_1 = this;
            //	ID	int
            //	Aktiv	bit
...
#region  --== Public Metodes ==--
        ...
        public static int Delete(Infosites isp)
        {
        ...
        public static int Insert(Infosites isp)
        {
            DBAccess db = new DBAccess();
        ...
        public static int Update(Infosites isp)
        {
            DBAccess db = new DBAccess();
            var with_1 = isp;
            PopulateDBwithInfositePages(db, isp);
        ...
        {
            Infosites isp = Infosites.GetInfositePages(ID);
            isp.Aktiv = Aktiv;
            isp.Site_FK = Site_FK;
            isp.Parent_ID = Parent_ID;
            isp.Sort = Sort;
        ...
        public static Infosites GetInfositePages(int ID)
        {
            DBAccess db = new DBAccess();
            //db.Parameters.Add(New SqlParameter("@ID", ID))
            db.AddInt("ID", ID);
        ...
        public static int MoveUp(Infosites c)
        {
            return MoveUp(c.ID);
        }
        ...
        public static int MoveLeft(Infosites c)
        {
        ...
        public static int MoveRight(Infosites c)
        {
            return MoveDown(c.ID);
        }
        ...
        public static int MoveDown(Infosites c)
        {
            return MoveDown(c.ID);
        }
