...
namespace RescueTekniq.BOL
{
    ...
    //		OpenDate	datetime
    //		ExpireDate	datetime
    //		RettetAf	nvarchar(256)
    //		RettetDen	datetime
    //		RettetIP	nvarchar(15)
    //---------------------------------------------------------------------------
    
    public class InfositePages : BaseObject
    {
        
#region  --== New ==--
        
        public InfositePages()
        {
            ID = -1;
        }
        
        public InfositePages(int ID, bool Aktiv, int Site_FK, int Parent_ID, int Sort, bool IncludeInMenu, bool IsDeleted, bool IsDisabled, string PageName, string PageTitle, string Description, string Keywords, int Template_ID, int Category_ID, int LinkType_ID, string LinkUrl, int LinkPage_ID, string LinkTarget, DateTime OpenDate, DateTime ExpireDate) : this()
        {
            var with_1 = this;
            with_1.Aktiv = Aktiv;
            with_1.Site_FK = Site_FK;
            with_1.Parent_ID = Parent_ID;
            with_1.Sort = Sort;
            with_1.IncludeInMenu = IncludeInMenu;
            with_1.IsDeleted = IsDeleted;
            with_1.IsDisabled = IsDisabled;
            with_1.Forside = false;
            with_1.PageName = PageName;
            with_1.PageTitle = PageTitle;
            with_1.Description = Description;
            with_1.Keywords = Keywords;
            with_1.Template_ID = Template_ID;
            with_1.Category_ID = Category_ID;
            with_1.LinkType_ID = LinkType_ID;
            with_1.LinkUrl = LinkUrl;
            with_1.LinkPage_ID = LinkPage_ID;
            with_1.LinkTarget = LinkTarget;
...
#region  --== Public Metodes ==--
        ...
        public static int Delete(InfositePages isp)
        {
            return Delete(isp.ID);
        }
        
        
        private static void PopulateDBwithInfositePages(DBAccess db, InfositePages po)
        {
            var with_1 = po;
        ...
        public static int Insert(InfositePages isp)
        {
            DBAccess db = new DBAccess();
        ...
        {
            InfositePages isp = new InfositePages();
            isp.Aktiv = Aktiv;
            isp.Site_FK = Site_FK;
        ...
        public static int Update(InfositePages isp)
        {
            DBAccess db = new DBAccess();
            var with_1 = isp;
            PopulateDBwithInfositePages(db, isp);
        ...
        {
            InfositePages isp = InfositePages.GetInfositePages(ID);
            isp.Aktiv = Aktiv;
            isp.Site_FK = Site_FK;
            isp.Parent_ID = Parent_ID;
            isp.Sort = Sort;
        ...
        public static InfositePages GetInfositePages(int ID)
        {
            DBAccess db = new DBAccess();
            //db.Parameters.Add(New SqlParameter("@ID", ID))
            db.AddInt("ID", ID);
        ...
        private static void PopulateInfositePages(SqlDataReader dr, InfositePages isp)
        {
            var with_1 = isp;
        ...
        public static int MoveUp(InfositePages c)
        {
            return MoveUp(c.ID);
        }
        ...
        public static int MoveLeft(InfositePages c)
        {
        ...
        public static int MoveRight(InfositePages c)
        {
            return MoveDown(c.ID);
        }
        ...
        public static int MoveDown(InfositePages c)
        {
            return MoveDown(c.ID);
        }
